...
void loop() {
  ...
  if (analogSensor > sensorThres)
  {
    ...
    digitalWrite(greenbulb, LOW);
     ...
     Serial.println("AT+CMGS=\"+917011359407\"\r"); // Replace x with mobile number
     ...
     Serial.println("ATD7011359407;"); // ATDxxxxxxxxxx; semicolon should be at the last ;AT command that follows UART protocol;
